<nav class="navbar navbar-expand navbar-light navbar-bg">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="{{ asset('template/img/avatars/avatar.jpg') }}" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Charles Hall</span>
              </a>
		...
		@auth
       <!-- Only show the logout form if the user is authenticated -->
